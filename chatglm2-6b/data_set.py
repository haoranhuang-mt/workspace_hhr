    ...
    def __init__(self, data_path, tokenizer, max_len, max_src_len, prompt_text):
        ...
        with open(data_path, "r", encoding="utf-8") as fh:
            for i, line in enumerate(fh):
                ...
                tokens = prompt_tokens + src_tokens + ["[gMASK]", "sop"] + tgt_tokens + ["eps"]
                ...
                input_ids = input_ids + [tokenizer.special_tokens['<pad>']] * pad_len
...
if __name__ == "__main__":
   tokenizer = ChatGLMTokenizer.from_pretrained("/data2/nlp/models/chatglm-6b/")
   train_dataset = Seq2SeqDataSet('data/data_huiben.json', tokenizer, 1024, 64, '')
